...
# Выводы:  
В ходе анализа было установлено,что вместимость ресторанов и цены на блюда являются ключевыми факторами, определяющими уровень дохода. Регрессионный анализ так же показал, что эти факторы оказывают значительное влияние на доход ресторанов.    
