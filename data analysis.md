...
### Регрессионный анализ, коэф-т детерминации R² 
Рассмотрим силу влияния факторов на доход.  
R² для Seating Capacity и Revenue: **0.459** (умеренная зависимость).  
Примерно **45.9%** дохода можно объяснить количеством посадочных мест.  
...
# Выводы:  
В ходе анализа было установлено, что расположение ресторанов (центр города, пригород или сельская местность), тип кухни, вместимость и цены на блюда являются ключевыми факторами, определяющими уровень дохода. Регрессионный анализ так же показал, что эти факторы оказывают значительное влияние на доход ресторанов.    
